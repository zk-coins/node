...
- [`CLAUDE.md`](./CLAUDE.md) — **start here for fresh sessions.** Onboarding, project invariants, decision recipe, pre-push checklist, foot-gun summary, navigation aid for everything below.
